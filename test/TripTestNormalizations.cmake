...
macro(normalize_data_model)
    ...
    normalize_regex("([0-9]+) multiletter control sequences out of ([0-9]+)" "[X] multiletter control sequences out of [Y]")
    ...
    normalize_regex(" hyphenation exceptions out of [0-9]+" " hyphenation exceptions out of [H]")
endmacro()
...
macro (normalize_excess_newlines)
    normalize_regex("[\n]+" "\n")
endmacro()
